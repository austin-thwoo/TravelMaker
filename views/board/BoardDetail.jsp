...
<body>
	...
	<div class="container">
		<div class="row contaniner-fluid">
			<div class="col text-start">글제목</div>
			<div class="col d-flex justify-content-end text-end">
				<ul class="list-group list-group-horizontal">
					<li class="list-group-item border-0 p-1">닉네임</li>
					<li class="list-group-item border-0 p-1">조회 10</li>
					<li class="list-group-item border-0 p-1">추천 5</li>
					<li class="list-group-item border-0 p-1">01/20 12:27</li>
				</ul>
			</div>
		</div>
		...
		<div class="row container-fluid mb-1">
			<div class="text-end">
				<button type="button" class="btn btn-outline-warning btn-md">수정</button>
		...
		<!-- 댓글 -->
		<div class="row container-fluid border border-start-0 border-end-0 mb-1">
			<div class="col-1">
				닉네임
			</div>
			<div class="col">
