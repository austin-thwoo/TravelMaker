...
<script type="text/javascript">
	function pointInsert(MID){
		opener.location.href = "pointInsert?MID="+MID+"&POAMOUNT="+document.getElementById("POAMOUNT").value+"&POSTATE="+document.querySelector('input[name="POSTATE"]:checked').value+"&POINFO="+document.getElementById("POINFO").value+"&MLEVEL="+${MLEVEL};
		self.close();
	}
</script>
</html>
